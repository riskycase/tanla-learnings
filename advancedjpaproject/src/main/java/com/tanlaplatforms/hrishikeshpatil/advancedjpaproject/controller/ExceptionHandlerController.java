...
public class ExceptionHandlerController {
        ...
        @ExceptionHandler
        public ResponseEntity<GenericExceptionResponse> handleCourseNotFoundException(
                        EntityNotFoundException courseNotFoundException) {
                return new ResponseEntity<GenericExceptionResponse>(
                                new GenericExceptionResponse(HttpStatus.NOT_FOUND.value(),
                                                courseNotFoundException.getMessage(), System.currentTimeMillis()),
        ...
        public ResponseEntity<GenericExceptionResponse> handleException(Exception exception) {
                return new ResponseEntity<GenericExceptionResponse>(
                                new GenericExceptionResponse(HttpStatus.BAD_REQUEST.value(),
